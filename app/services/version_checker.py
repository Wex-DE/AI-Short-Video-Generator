...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/Wex-DE/AI-Short-Video-Generator/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/Wex-DE/AI-Short-Video-Generator/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "WexAuto-Version-Checker",
}
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a WexAuto update"
            )
